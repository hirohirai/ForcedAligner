...
- F0, World 20KHz 
- `spk=s39;for fn in ../../ForcedAligner/out/wav/$spk/*.wav ;do; ./calF0.py --min_f0 40 --max_f0 420 -i $fn -o Result_rtmri/$spk/${(U)fn:r:t}.f0;done`
- `spk=s39;for fn in ./out/wav/$spk/*.wav;do;python ./tools/world.py $fn --f0 ~/work_local/Speech/world_work/F0/Result_rtmri/$spk/${fn:r:t}.f0 --odir ../DBS_/rt-atr503/world/$spk ;done`
- 予測
...
- TextGridへ変換
- `for fn in out/npy/s31/*.npy;do; echo $fn; python3 tools/fa_dp.py --st_time 0.01 --ed_time 20.0 out/TextGrid_o/s31/${fn:r:t}.TextGrid $fn >| out/TextGrid/s31/${fn:r:t}.TextGrid --dur_weight 10.0;done`
